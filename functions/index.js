...
var PaytmConfig = {
  mid: 'dEqnoF28285300523531',
  key: 'wFY@dbtZu#4ohwdw',
  website: 'WEBSTAGING'
};

exports.paytm = functions.https.onRequest((req, res) => {
  ...
  switch (req.url) {
    case '/':
      ...
      params['CALLBACK_URL'] = 'https://us-central1-physionext-d454f.cloudfunctions.net/paytm/appointment-confirm';
